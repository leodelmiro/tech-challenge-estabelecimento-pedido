...
import com.leodelmiro.estabelecimento.config.MercadoPagoClientConfig;
...
@FeignClient(name = "mercadoPagoClient", url = "${external-apis.mercadopago.url}", configuration = MercadoPagoClientConfig.class)
